...
install(TARGETS mb_inference
        RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR}/mbase/${MBASE_INFERENCE_LIB_NAME}
        LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/mbase/${MBASE_INFERENCE_LIB_NAME}
        ARCHIVE DESTINATION ${CMAKE_INSTALL_LIBDIR}/mbase/${MBASE_INFERENCE_LIB_NAME}
)

install(FILES ${MBASE_INFERENCE_INCLUDE_INSTALL_FILES}
        PERMISSIONS
            OWNER_READ
            OWNER_WRITE
            GROUP_READ
            WORLD_READ
        DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/mbase/${MBASE_INFERENCE_LIB_NAME})
