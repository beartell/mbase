...
//{
//	llama_sample_top_k(mSelfContext, mTokenArray, mCommonFloat, 999);
//}
//
...
//{
//	llama_sample_typical(mSelfContext, mTokenArray, mCommonFloat, 999);
//}
//
...
//{
//	llama_sample_top_p(mSelfContext, mTokenArray, mCommonFloat, 999);
//}
//
...
//{
//	llama_sample_min_p(mSelfContext, mTokenArray, mCommonFloat, 999);
//}
//
//InfSamplingTailFree::InfSamplingTailFree(llama_context* in_ctx, llama_token_data_array* in_array) : InfSamplingBase(in_ctx, in_array, "TFZ")
//{
//}
//
...
//{
//	llama_sample_tail_free(mSelfContext, mTokenArray, mCommonFloat, 999);
//}
//
