...
struct smart_conversion<I8, StringType>{
    ...
    static I8 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<I16, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static I16 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<I32, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static I32 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<I64, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static I64 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<U8, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static U8 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<U16, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static U16 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<U32, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static U32 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<U64, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static U64 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<F32, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static F32 apply(string_type::const_pointer in_string)
    {
...
struct smart_conversion<F64, StringType>{
    using string_type = std::conditional_t<std::is_same_v<StringType, mbase::string>, mbase::string, mbase::wstring>;
    static F64 apply(string_type::const_pointer in_string)
    {
