...
public:
	...
	MBASE_INLINE const_linear_bucket_iterator(const_linear_bucket_iterator&& in_rhs) noexcept;
	MBASE_INLINE const_linear_bucket_iterator(const linear_bucket_iterator<MapContainer, BucketIterator>& in_rhs) noexcept;
	MBASE_INLINE const_linear_bucket_iterator(linear_bucket_iterator<MapContainer, BucketIterator>&& in_rhs) noexcept;
	/* ===== BUILDER METHODS END ===== */

	/* ===== OPERATOR BUILDER METHODS BEGIN ===== */
	MBASE_INLINE const_linear_bucket_iterator& operator=(const const_linear_bucket_iterator& in_rhs) noexcept;
	MBASE_INLINE const_linear_bucket_iterator& operator=(const_linear_bucket_iterator&& in_rhs) noexcept;
	...
	MBASE_INLINE const_linear_bucket_iterator& operator=(linear_bucket_iterator<MapContainer, BucketIterator>&& in_rhs) noexcept;
	/* ===== OPERATOR BUILDER METHODS END ===== */
