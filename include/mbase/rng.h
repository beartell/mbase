...
USED_RETURN MBASE_INLINE I32 gen_random_32() noexcept {
	I32 freshNumber = 0;
	BCryptGenRandom(gCryptoManager.rng_rng.providerHandle, (PUCHAR)&freshNumber, sizeof(I32), 0);
	return freshNumber;
}

USED_RETURN MBASE_INLINE I64 gen_random_64() noexcept {
	I64 freshNumber = 0;
	BCryptGenRandom(gCryptoManager.rng_rng.providerHandle, (PUCHAR)&freshNumber, sizeof(I64), 0);
	return freshNumber;
}

USED_RETURN MBASE_INLINE GENERIC gen_random_n(IBYTEBUFFER in_buffer, SIZE_T in_length) noexcept {
