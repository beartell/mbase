...
static const U32 gInfProcessorDefaultBatchSize = 1024;
...
public:
	...
	flags initialize(const mbase::string& in_model, const I32& in_gpu_layers = -1); 
	flags load_model(const mbase::string& in_model, const I32& in_gpu_layers = -1); // same with initialize
	flags unload_model();
