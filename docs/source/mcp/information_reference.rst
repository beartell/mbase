...
.. toctree::
    ...
    MCP SDK Design <info-reference/mcp_sdk_design>
    MCP Server in Detail <info-reference/mcp_server_detail>
    MCP Client in Detail <info-reference/mcp_client_detail>
